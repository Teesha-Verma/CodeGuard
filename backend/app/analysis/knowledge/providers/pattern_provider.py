...
class PatternProvider(KnowledgeProvider):
    """
    Provides reusable vulnerability pattern documents.
    ...
    def __init__(self, knowledge_dir: str = "knowledge/patterns"):
    ...
    def get_category(self) -> DocumentCategory:
        return DocumentCategory.PATTERN
