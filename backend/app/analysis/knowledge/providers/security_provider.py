...
class SecurityProvider(KnowledgeProvider):
    """
    Provides security-focused knowledge documents.
    ...
    def __init__(self, knowledge_dir: str = "knowledge/security"):
    ...
    def get_category(self) -> DocumentCategory:
        return DocumentCategory.SECURITY
    ...
    def _load_markdown_file(self, file_path: str) -> KnowledgeDocument | None:
        try:
            ...
            if "owasp" in lower_name:
                tags.append("owasp")
            if "cwe" in lower_name:
                tags.append("cwe")
