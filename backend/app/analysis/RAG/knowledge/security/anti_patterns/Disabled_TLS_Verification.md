---
knowledge_id: KB-Disabled_TLS_Verification
embedding_title: Disabled TLS Verification Anti-Pattern - Security Knowledge Document
official_id: Disabled_TLS_Verification
document_type: anti_pattern
chunk_type: concept_and_detection
title: Disabled TLS Verification Anti-Pattern
category: security
...
tags:
  ...
  - cwe-295
keywords:
  - disabled tls verification anti-pattern
  - cwe-295
aliases:
...
# Retrieval Summary
This document covers Disabled TLS Verification Anti-Pattern (Disabled_TLS_Verification). It defines security objectives, threat models, detection guidance, AST hints, and Python code examples across FastAPI, Flask, and Django to eliminate vulnerabilities and ensure robust software assurance.

# Overview
Disabling SSL certificate verification in HTTP clients (`verify=False`).
...
# Review Checklist
- [ ] Verify requirement for Disabled_TLS_Verification is enforced in code.
...
# References
1. Official Security Standard: https://cwe.mitre.org/data/definitions/295.html
