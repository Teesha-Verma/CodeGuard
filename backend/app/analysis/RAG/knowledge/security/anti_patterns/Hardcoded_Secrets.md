---
knowledge_id: KB-Hardcoded_Secrets
embedding_title: Hardcoded Secrets Anti-Pattern - Security Knowledge Document
official_id: Hardcoded_Secrets
...
# Retrieval Summary
This document covers Hardcoded Secrets Anti-Pattern (Hardcoded_Secrets). It defines security objectives, threat models, detection guidance, AST hints, and Python code examples across FastAPI, Flask, and Django to eliminate vulnerabilities and ensure robust software assurance.

# Overview
Embedding passwords, private keys, or API tokens directly in source code.
...
# Review Checklist
- [ ] Verify requirement for Hardcoded_Secrets is enforced in code.
