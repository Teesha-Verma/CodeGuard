---
knowledge_id: KB-MSC01_P
embedding_title: Do not use random module for security-critical applications - Security Knowledge Document
official_id: MSC01-P
document_type: cert_python
chunk_type: concept_and_detection
title: Do not use random module for security-critical applications
category: security
...
tags:
  ...
  - cwe-330
keywords:
  - do not use random module for security-critical applications
  - cwe-330
aliases:
  - MSC01-P
  - Do not use random module for security-critical applications
...
# Retrieval Summary
This document covers Do not use random module for security-critical applications (MSC01-P). It defines security objectives, threat models, detection guidance, AST hints, and Python code examples across FastAPI, Flask, and Django to eliminate vulnerabilities and ensure robust software assurance.

# Overview
The standard random module uses MT19937 PRNG which is predictable.
...
```python
import random; token = random.randint(1000, 9999)
```

# Secure Patterns
Secure implementation:
```python
import secrets; token = secrets.randbelow(9000) + 1000
```
...
# Review Checklist
- [ ] Verify requirement for MSC01-P is enforced in code.
...
# References
1. Official Security Standard: https://cwe.mitre.org/data/definitions/330.html
