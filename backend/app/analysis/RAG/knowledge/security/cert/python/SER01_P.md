---
knowledge_id: KB-SER01_P
embedding_title: Do not use pickle or marshal for deserialization of untrusted data - Security Knowledge Document
official_id: SER01-P
document_type: cert_python
chunk_type: concept_and_detection
title: Do not use pickle or marshal for deserialization of untrusted data
category: security
...
tags:
  ...
  - cwe-502
keywords:
  - do not use pickle or marshal for deserialization of untrusted data
  - cwe-502
aliases:
  - SER01-P
  - Do not use pickle or marshal for deserialization of untrusted data
...
# Retrieval Summary
This document covers Do not use pickle or marshal for deserialization of untrusted data (SER01-P). It defines security objectives, threat models, detection guidance, AST hints, and Python code examples across FastAPI, Flask, and Django to eliminate vulnerabilities and ensure robust software assurance.

# Overview
The pickle and marshal modules are insecure against erroneous or maliciously constructed data.
...
# Review Checklist
- [ ] Verify requirement for SER01-P is enforced in code.
