---
knowledge_id: KB-CWE_78
embedding_title: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') - Security Knowledge Document
official_id: CWE-78
document_type: cwe
...
# Retrieval Summary
This document covers Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') (CWE-78). It defines security objectives, threat models, detection guidance, AST hints, and Python code examples across FastAPI, Flask, and Django to eliminate vulnerabilities and ensure robust software assurance.

# Overview
The software constructs an OS command using externally-influenced input without proper neutralization.
...
# Review Checklist
- [ ] Verify requirement for CWE-78 is enforced in code.
