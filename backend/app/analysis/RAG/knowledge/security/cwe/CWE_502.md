---
knowledge_id: KB-CWE_502
embedding_title: Deserialization of Untrusted Data - Security Knowledge Document
official_id: CWE-502
document_type: cwe
...
# Retrieval Summary
This document covers Deserialization of Untrusted Data (CWE-502). It defines security objectives, threat models, detection guidance, AST hints, and Python code examples across FastAPI, Flask, and Django to eliminate vulnerabilities and ensure robust software assurance.

# Overview
The application deserializes untrusted data without verifying that the resulting data is valid or safe.
...
```python
pickle.loads(user_raw_data)
```

# Secure Patterns
Secure implementation:
```python
json.loads(user_raw_data)
```
...
# Review Checklist
- [ ] Verify requirement for CWE-502 is enforced in code.
