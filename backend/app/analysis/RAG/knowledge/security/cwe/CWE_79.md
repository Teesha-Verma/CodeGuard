---
knowledge_id: KB-CWE_79
embedding_title: Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting') - Security Knowledge Document
official_id: CWE-79
document_type: cwe
...
# Retrieval Summary
This document covers Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting') (CWE-79). It defines security objectives, threat models, detection guidance, AST hints, and Python code examples across FastAPI, Flask, and Django to eliminate vulnerabilities and ensure robust software assurance.

# Overview
The software does not neutralize or incorrectly neutralizes user-controllable input before rendering it in web pages.
...
# Review Checklist
- [ ] Verify requirement for CWE-79 is enforced in code.
...
# References
1. Official Security Standard: https://cwe.mitre.org/data/definitions/79.html
