...
ASVS_DIR = r"d:\RAG\knowledge\security\owasp\asvs"
WSTG_DIR = r"d:\RAG\knowledge\security\owasp\wstg"

REQUIRED_FM_KEYS = [
    "knowledge_id", "embedding_title", "official_id", "document_type",
    "chunk_type", "language", "frameworks", "database", "retrieval_priority",
    "source_version", "confidence", "severity", "category", "subcategory",
    "source", "canonical_url", "tags", "keywords", "aliases",
    "related_topics", "related_documents", "last_updated"
]

ASVS_REQUIRED_HEADERS = [
    "# Retrieval Summary", "# Overview", "# Official Requirement",
    "# Security Objective", "# Why This Matters", "# Threat Model",
    "# Detection Guidance", "# AST Detection Hints", "# Regex / Search Hints",
    ...
    "# Related Cheat Sheets", "# Related CWE", "# Related CERT Python Rules",
    "# Related PEPs", "# Related Security Patterns", "# Related Anti-Patterns",
    "# Related Repository Rules", "# Related WSTG Tests", "# References"
]

WSTG_REQUIRED_HEADERS = [
    "# Retrieval Summary", "# Overview", "# Official Test",
    "# Security Objective", "# Why This Matters", "# Threat Model",
    "# Detection Guidance", "# AST Detection Hints", "# Regex / Search Hints",
    "# Semantic Detection Hints", "# Relevant Python APIs", "# Relevant Imports",
    "# Vulnerable Patterns", "# Secure Patterns", "# Python Example",
    ...
    "# Related Cheat Sheets", "# Related CWE", "# Related CERT Python Rules",
    "# Related PEPs", "# Related Security Patterns", "# Related Anti-Patterns",
    "# Related Repository Rules", "# Related ASVS Requirements", "# References"
]

def verify():
    print("Starting Comprehensive ASVS & WSTG Knowledge Base Verification...")
    ...
    for base_dir in [ASVS_DIR, WSTG_DIR]:
        for root, dirs, files in os.walk(base_dir):
            for file in files:
                ...
                body = parts[2]
                is_asvs = "asvs" in file_path.lower()
                req_headers = ASVS_REQUIRED_HEADERS if is_asvs else WSTG_REQUIRED_HEADERS
    ...
    if errors == 0:
        print("SUCCESS: 100% Validation Passed! Zero errors found.")
    else:
